...
offcoordinateElevationCorrection.xlsx	- for finding and correcting survey deviations. Matches survey shots based on description and applies an appropriate elevation correction to all shots in the same or linked setup.
...
xsReduction.xlsx - Uses a simple stochastic algorithm to reduce the number of shots in a cross section for the purpose of fitting the shots onto a column-limited chart.
